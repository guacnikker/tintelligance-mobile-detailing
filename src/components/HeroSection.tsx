...
import tintelligentLogo from "/lovable-uploads/602ae080-3c25-42b6-8a8a-c24abbb2c96e.png";
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 sm:mb-8 flex justify-center">
          <img 
            ...
            className="h-28 w-28 sm:h-36 sm:w-36 md:h-44 md:w-44 rounded-full shadow-neon animate-pulse-neon"
          />
        </div>
